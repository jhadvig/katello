...
module Validators
  class KatelloNameUtf8FormatValidation < ActiveModel::EachValidator

    def validate_each(record, attribute, value)
      if value
        record.errors[attribute] << N_("cannot contain characters other than UTF-8, space, '_', '-'") unless value =~ /\A[\w\P{ASCII}| |_|-]*\Z/
